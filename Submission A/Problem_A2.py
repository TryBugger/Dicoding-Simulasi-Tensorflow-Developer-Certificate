...
def solution_A2():
    ...
    model=tf.keras.models.Sequential([
        # YOUR CODE HERE, end with a Neuron Dense, activated by sigmoid
            tf.keras.layers.Conv2D(16, 7, activation='relu', input_shape=(150, 150, 3)),
    ...
    LROcallbacks = ReduceLROnPlateau(monitor='val_loss',
                                     factor=0.75,
                                     patience=5,
                                     verbose=1,
                                     min_lr=1e-5)
    ...
    model.fit(train_generator,
              ...
              epochs=30,
              verbose=1,
              callbacks=[LROcallbacks,
                         StopAccuracyCallback()])
